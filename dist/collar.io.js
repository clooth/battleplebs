...
(function (Collar) {
    var Player = (function (_super) {
        ...
        function Player(state, x, y) {
            _super.call(this, state, state.textures.player, x, y);
        ...
        Player.prototype.handleControls = function () {
            var movementDeltaX = this.speedX * this.game.time.delta() / 100;
            var movementDeltaY = this.speedY * this.game.time.delta() / 100;
...
(function (Collar) {
    var MainState = (function (_super) {
        ...
        MainState.prototype.create = function () {
            ...
            this.player = new Collar.Player(this, this.game.stage.width / 2, this.game.stage.height);
    ...
    Collar.MainState = MainState;
})(Collar || (Collar = {}));
//# sourceMappingURL=collar.io.js.map